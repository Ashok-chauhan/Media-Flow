...
////////////////////////// added by ashok 08/10/2010 //////////////////////////////
	...
	function getVideoList() { 
		...
		$resizeApi = 'https://resizer.whizti.com/api/resize/600?url=';
				...
				foreach($itemElements as $element) {
					switch($element->nodeName) {
						...
						case "media:content":
							...
							if($mediaContent['medium'] == 'image') $feedDef['icon_uri'] = urldecode($mediaContent['url']);
						...
						case "media:thumbnail":
							...
							for ($i = 0; $i < $length; ++$i) {
								if($element->attributes->item($i)->name == 'url')
									//$feedDef['icon_uri'] = $resizeApi.urlencode($element->attributes->item($i)->value);
									$feedDef['icon_uri'] = $resizeApi.urldecode($element->attributes->item($i)->value);
							}
							break;
