...
class JewishgalleryHandler
{
    ...
    function getGalleryList()
    {
        ...
        foreach ($itemElements as $element) {
			...
			$galleryDef['gallery']['assetid'] = $element->articleMetadata->galleryURL;
    ...
    function refreshPhotos($photos, $category_id, $parent_id)
    {
        ...
        foreach ($photos as $photo) {
			...
			/// to respond in JSON media object for photo gallery . Added on 09/06/2013 for app v2
...
/*
* Added on 09/06/2013 for app v2
...
*/
protected function multiMedia($data, $content_id, $category_id){
			global $CI;
			$mediaData = array(
