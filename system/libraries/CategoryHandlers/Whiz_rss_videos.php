...
///////////////////// EOF EXTRA IMAGE(MEDIA) MANIPULATIN //////////////
                        ...
                        case "pubDate":
                            ...
                            /*
							* offset are not needed any more.
							$noff = explode('-', $element->nodeValue);
                            if (count($noff) > 1) {
                                $feedDef['offset'] = '-' . $noff[count($noff) - 1];
                            }
                            $poff = explode('+', $element->nodeValue);
                            if (count($poff) > 1) {
                                $feedDef['offset'] = '+' . $poff[count($poff) - 1];
                            }
							*/
                            break;
                        ...
                        case "author":
                            ...
                            break;
                        ////////// EOF FOR AUTHOR //////////////////////
                        ///////// BOF FOR COMMENTS URI ADDED BY KIRAN////////
                        case "comments":
